    ...
    <header className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <a href="#radar" className="text-muted-foreground hover:text-foreground transition-colors">
            Radar
          </a>
          <a href="#lifecycle" className="text-muted-foreground hover:text-foreground transition-colors">
            Lifecycle
          </a>
        ...
        <div className="flex items-center space-x-4">
          {user ? (
            ...
            <>
              ...
              <Button size="sm" className="pulse-glow" asChild>
